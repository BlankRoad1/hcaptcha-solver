...
class Challenge:
    ...
    def _request(self, method, url, headers=None, data=None, json=None):
        ...
        # if your proxies are paid and you think the program is fucked instead of your proxies, Uncomment the below code in stars !!

        # what does this do ? it reconnects the request, connect = 1 means retry once. backoff factor etc i dont know.
        # This should solve your headache of max ssl reached. 
        # if you got better ideas. open an issue or pull request. so we can find fix for the max ssl :'(
